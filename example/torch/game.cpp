...
//Sandbox::Sandbox(stella::graphics::Display &display) : Display(display) {
  ...
  //this->scriptApi.vm.set_function("create_layer", &Sandbox::create_layer, this);
  //this->scriptApi.vm.set_function("e_create_entity", &Sandbox::create_entity, this);
  //this->scriptApi.vm.set_function("e_add_component", &Sandbox::add_component, this);
  //this->scriptApi.vm.set_function("update_camera", &Sandbox::update_camera, this);
  //this->scriptApi.vm.set_function("get_position", &Sandbox::get_position, this);
  //this->scriptApi.vm.set_function("get_perlin_int", &Sandbox::get_perlin_int, this);
  //this->scriptApi.vm.set_function("get_random_int", &Sandbox::get_random, this);
...
//std::tuple<int,int,int> Sandbox::get_position(entt::registry::entity_type entity)
//{
...
//void Sandbox::add_sprite_component(entt::registry::entity_type id, const sol::table &obj)
//{
...
//void Sandbox::add_position_component(entt::registry::entity_type id, const sol::table &obj)
//{
...
//void Sandbox::add_dimension_component(entt::registry::entity_type id, const sol::table &obj)
//{
...
//void Sandbox::add_animation_component(entt::registry::entity_type id, const sol::table &obj)
//{
  //const float &framew = obj["frame_dimensions"][1];
  //const float &frameh = obj["frame_dimensions"][2];
...
//void Sandbox::add_tileview_component(entt::registry::entity_type id, const sol::table &obj)
//{
  //this->Registry.assign<stella::components::TileviewComponent>(id);
//}

//void Sandbox::add_movement_component(entt::registry::entity_type id, const sol::table &obj)
//{
...
//void Sandbox::add_player_component(entt::registry::entity_type id, const sol::table &obj)
//{
  //this->Registry.assign<stella::components::PlayerComponent>(id);
//}

//void Sandbox::add_body_component(entt::registry::entity_type id, const sol::table &obj)
//{
...
//void Sandbox::add_text_component(entt::registry::entity_type id, const sol::table &obj)
//{
...
//void Sandbox::add_particle_emitter_component(entt::registry::entity_type id, const sol::table &obj)
//{
...
//void Sandbox::add_tile_component(entt::registry::entity_type id, const sol::table &obj)
//{
  //this->Registry.assign<stella::components::TileComponent>(id);
//}

//void Sandbox::add_scroll_component(entt::registry::entity_type id, const sol::table &obj)
//{
