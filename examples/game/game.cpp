...
Game::Game(stella::graphics::Display &display, stella::graphics::Shader *shader, const bool *keys) {
	...
	mou2.assign<MovementComponent>(-3.0f, 0.0f, 3.0f, false);
	...
	mou2a.assign<MovementComponent>(-3.0f, 0.0f, 3.0f, false);
	...
	mou3.assign<MovementComponent>(-5.0f, 0.0f, 5.0f, false);
	...
	mou3a.assign<MovementComponent>(-5.0f, 0.0f, 5.0f, false);
