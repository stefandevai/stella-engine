...
void PlayerMovementSystem::update(entityx::EntityManager &es, entityx::EventManager &events, entityx::TimeDelta dt) {
	es.each<MovementComponent, SpatialComponent, InputComponent, TextureComponent>([this](entityx::Entity entity, MovementComponent &mov, SpatialComponent &spa, InputComponent &input, TextureComponent &tex) {
