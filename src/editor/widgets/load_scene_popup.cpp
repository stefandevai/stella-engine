...
namespace widget
{
  LoadScenePopup::LoadScenePopup (std::shared_ptr<stella::Game>& game) : Widget ("load-scene-popup"), m_game (game) {}

  void LoadScenePopup::open() { ImGuiFileDialog::Instance()->OpenModal ("load-scene-file-dialog1", "New Scene", ".json", "."); }
