...
namespace core
{
  ModelLoader::ModelLoader (const std::string& filepath, AssetManager* asset_manager)
    : AssetLoader(AssetType::MODEL), m_filepath(filepath), m_asset_manager (asset_manager)
  {
