...
namespace graphics
{
  SpriteLayerT::SpriteLayerT(const std::string& vert_shader_path, const std::string& frag_shader_path)
  : LayerT(), shader(std::make_shared<Shader>(vert_shader_path.c_str(), frag_shader_path.c_str()))
  {
