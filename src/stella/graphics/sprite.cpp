...
namespace graphics
{
  ...
  Sprite::Sprite (GLint x, GLint y, Texture& texture, GLuint frame) : Renderable (x, y, texture)
  {
    this->Color          = 4294967295; // r = 255, g = 255, b = 255, a = 255
  ...
  Sprite::Sprite (GLint x, GLint y, GLint w, GLint h, Texture& texture, GLuint frame) : Renderable (x, y, w, h, texture)
  {
    this->Color          = 4294967295; // r = 255, g = 255, b = 255, a = 255
    this->NumberOfFrames = 1;
    this->Frame          = frame;
  ...
  Sprite::Sprite (glm::vec3 position, Texture& texture, GLuint frame) : Renderable (position, texture)
  {
    this->Color          = 4294967295; // r = 255, g = 255, b = 255, a = 255
    this->NumberOfFrames = 1;
    this->Frame          = frame;
