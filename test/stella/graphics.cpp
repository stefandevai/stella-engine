...
{
  stella::component::Color color = stella::component::Color ("#4db88fff");
  ...
  stella::component::Color color2 = stella::component::Color (77, 184, 143, 255);
