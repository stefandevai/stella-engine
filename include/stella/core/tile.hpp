...
namespace core
{
  struct Tile
  {
    ...
    bool operator== (const Tile& other) const
    {
      ...
      if (this->x == other.x && this->y == other.y && this->z == other.z && this->value == other.value && this->visible == other.visible && this->collidable == other.collidable &&
          this->entity == other.entity && this->solid_edges == other.solid_edges && this->custom_edges == other.custom_edges && this->active_edges == other.active_edges)
      {
        return true;
      }
      return false;
