...
class BitmapTextSystem : public System
{
  public:
    ...
    {
      registry.group<components::BitmapTextComponent>(entt::get<components::PositionComponent, components::DimensionComponent>).each([&registry](auto entity, auto &text, auto &pos, auto &dim)
      {
        if (!text.IsStatic) {
          int stride = 0;
