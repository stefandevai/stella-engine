...
class PlayerSystem : public System
{
  ...
  public:
    ...
    {
      registry.group<components::PlayerComponent>(entt::get<components::Body2DComponent, components::PositionComponent, components::DimensionComponent>).each([this, &registry](auto entity, auto &player, auto &body, auto &pos, auto &dim)
      {
  ...
  private:
    void SetState(PlayerSystem::State state, components::AnimationsComponent &anims, PlayerSystem::State previous_state)
    {
