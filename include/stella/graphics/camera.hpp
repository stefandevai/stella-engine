...
namespace graphics
{
  ...
  public:
    ...
    inline glm::mat4 get_projection_matrix() const { return glm::ortho(m_frustrum_left, m_frustrum_right, m_frustrum_bottom, m_frustrum_top, m_near, m_far); }
    inline glm::mat4 get_vp_matrix() const { return (glm::ortho(m_frustrum_left, m_frustrum_right, m_frustrum_bottom, m_frustrum_top, m_near, m_far) * glm::lookAt(m_position, m_front, m_up)); }
